...
@section('content')
    <section class="show-show-sec py-5 text-white light-border-bottom">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12 col-12">
                    <div class="sm-img-col">
                        @if($show['poster_path'])
                            <img src="{{ $show['poster_path'] }}" alt="{{ $show['name'] }}" class="w-100 show-poster-img">
                        @else
                            <img src="{{asset('img/movie-poster-no-image.jpg')}}" alt="{{ $show['name'] }}" class="w-100 show-poster-img">
                        @endif
                    </div>
                </div>
                ...
                <div class="col-md-8 col-sm-12 col-12">
                    <div class="sm-det-col px-3 py-md-2 pt-4">
                        <h2 class="font-weight-bolder">{{ $show['name'] }}</h2>
                        <div class="sm-rdg-col">
                            <span class="fa fa-star text-orange"></span>{{ $show['vote_average'] }} | <span class="sm-rdg-date">{{ $show['first_air_date'] }}</span> | 
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="embed-responsive embed-responsive-16by9">
                                                <iframe id="videoPlayer" class="embed-responsive-item" src="https://www.youtube.com/embed/{{ $show['videos']['results'][0]['key'] }}" allowfullscreen></iframe>
                                              </div>
                                        </div>
                                    </div>
                                </div>
